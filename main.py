...
template = """You are a friendly and knowledgable fitness chatbot. Answer questions within {number} words. Answer questions based on this chat's history..
...
st.set_page_config("Fitness Chatbot")
